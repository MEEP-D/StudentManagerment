...
using StudentManagerment.Views;
using StudentManagerment.ViewModels;
using StudentManagerment;
using System;
...
namespace StudentManagerment.ViewModels
{
	public class MainViewModel : BaseViewModel
	{
		...
		public MainViewModel()
		{
			...
			MainWindow.Notify.ShowBalloonTip(3000, "LangTrack - Trung tâm đào tạo anh ngữ", "Chào mừng bạn đến với LangTrack", System.Windows.Forms.ToolTipIcon.Info);
			//GotoLayoutView();
		}
